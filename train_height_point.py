...
def _main():
    annotation_path = '/home/jiangmingchao/height_point_dataset/voc_train.txt'
    log_dir = 'logs/height_point/'
    classes_path = '/home/jiangmingchao/height_point_dataset/train_classes.txt'
